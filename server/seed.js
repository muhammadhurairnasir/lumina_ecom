...
const buildProducts = (cats) => {
  ...
  return [
    ...
    },
    {
      ...
      category: fash, tags: ['trousers', 'chinos', 'slim-fit', 'stretch'],
    ...
    },
    {
      ...
      category: home, tags: ['coffee', 'ceramic', 'pour-over', 'kitchen'],
    ...
    // ── Accessories ──────────────────────────────────────────────────────────
    {
      ...
      category: acc, tags: ['wallet', 'leather', 'rfid', 'slim'],
    ...
    },
    {
      ...
      category: acc, tags: ['bag', 'canvas', 'tote', 'laptop'],
    ...
    },
    {
      ...
      category: acc, tags: ['watch', 'automatic', 'stainless-steel', 'sapphire'],
    ...
    },
    {
      ...
      category: neww, tags: ['organizer', 'bamboo', 'desk', 'sustainable'],
